...
- Motherboard RGB is driven by **OpenRGB as a host systemd service** (`192.168.2.70:6742`) for Home Assistant / any client — see [docs/OPENRGB_SERVER_SETUP.md](docs/OPENRGB_SERVER_SETUP.md). Do **not** USB-pass the Aura controller (`0b05:19af`) to a VM; it breaks host RGB control
